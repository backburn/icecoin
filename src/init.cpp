    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Icecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  icecoind [options]                     " + "\n" +
                  "  icecoind [options] <command> [params]  " + _("Send command to -server or icecoind") + "\n" +
                  "  icecoind [options] help                " + _("List commands") + "\n" +
                  "  icecoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: icecoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Icecoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Icecoin is probably already running."), strDataDir.c_str()));
