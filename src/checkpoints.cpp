...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpointsTestnet = 
        boost::assign::map_list_of
        (   0, uint256("0x67f7ea9c114184176c197f7daacdca375b83accf97ee6dece4cbb297964169c1"))
        ;
    ...
    int GetTotalBlocksEstimate()
    {
        ...
        //if (!GetBoolArg("-checkpoints", true)) // TODO: Enable when we actually have checkpoints.
            return 0;
